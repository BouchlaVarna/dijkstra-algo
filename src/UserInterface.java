...
public class UserInterface{
    ...
    public void run() {
        while (isRunning) {
            ...
            switch (sc.nextInt()) {
                ...
                case 3 -> dijkstraUtils.doDijkstra(dijkstraUtils.getNodeList().get(0));
    ...
    public void createNewEdge() {
        ...
        edge.setStartNode(dijkstraUtils.getNodeList().get(sc.nextInt()));
        edge.setEndNode(dijkstraUtils.getNodeList().get(sc.nextInt()));
        printUtils.printCurrentNodes(dijkstraUtils.getNodeList());
